...
crossoff_form = """
    <form action="/crossoff" method="post">
        ...
        <input type="submit" value="Crossoff Movie"/>
    </form>
...
def crossoff_movie():
    ...
    crossed_movie_text = "<strike>" + crossed_off_movie + "</strike>"
    sentence = crossed_movie_text + " has been crossed off your Watchlist."
